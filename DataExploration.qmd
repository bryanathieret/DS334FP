...
smoke100mod0 = glm(cbind(smoke100YES, smoke100NO) ~ age + sex + age*sex, family = "quasibinomial", data = smokefull2)
summary(smoke100mod0)
...
pairs(lsmeans(smoke100modmentalIllness, ~age|sex|MentalIllness))
