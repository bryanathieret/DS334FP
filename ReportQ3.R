...
bingeall = glm(occasions ~ 
                    ...
                    Neglect1 + 
                    Neglect2, 
                  family = "quasipoisson", data = bingedrinking)


bingeall1 = glm(occasions ~ age + sex + race +
                     MentalIllness + 
                     Alcoholic + 
                     SubstanceAddiction + 
                     Incarcerated + 
...
anova( bingeall1, bingeall, bingeall2, bingeall3, bingeall4, bingeall5, test = "Chisq") 
anova(bingeall, bingeall2, bingeall4, test = "Chisq") #bingeall4 is the best model. lowest deviance and df.
...
alco1 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  ...
  theme_minimal() +
  labs(x = "Average Occasions for Binge Drinking (per month)", title = "History of Alcohol Misuse in HH") +
  theme(
...
alco2 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
...
grid.arrange(alco1, alco2, nrow = 1)


mi1 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
  ...
  scale_color_viridis_d(option = "plasma", direction = 1, begin = 1, end = 0.30) +
  theme_minimal() +
  labs(x = "Average Occasions for Binge Drinking (per month)", title = "History of Mental Illness in HH") +
  theme(
    axis.title.y = element_blank(),
    axis.text.y = element_text(color = "black", size = 9, family = "Avenir"),
    axis.title.x = element_text(color = "black", size = 15, family = "Avenir"),
...
mi2 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
...
i1 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
  ...
  scale_color_viridis_d(option = "plasma", direction = 1, begin = 1, end = 0.30) +
  theme_minimal() +
  labs(x = "Average Occasions for Binge Drinking (per month)", title = "History of Incarcerated HH Member") +
  theme(
    axis.title.y = element_blank(),
    axis.text.y = element_text(color = "black", size = 9, family = "Avenir"),
    axis.title.x = element_text(color = "black", size = 15, family = "Avenir"),
...
i2 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
...
sd1 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
  ...
  scale_color_viridis_d(option = "plasma", direction = 1, begin = 1, end = 0.30) +
  theme_minimal() +
  labs(x = "Average Occasions for Binge Drinking (per month)", title = "History of Parental Separation/Divorce") +
  theme(
    axis.title.y = element_blank(),
    axis.text.y = element_text(color = "black", size = 9, family = "Avenir"),
    axis.title.x = element_text(color = "black", size = 15, family = "Avenir"),
...
sd2 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
...
dv1 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
  ...
  scale_color_viridis_d(option = "plasma", direction = 1, begin = 1, end = 0.30) +
  theme_minimal() +
  labs(x = "Average Occasions for Binge Drinking (per month)", title = "History of Domestic Violence in HH") +
  theme(
    axis.title.y = element_blank(),
    axis.text.y = element_text(color = "black", size = 9, family = "Avenir"),
    axis.title.x = element_text(color = "black", size = 15, family = "Avenir"),
...
dv2 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
...
pa1 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
  ...
  scale_color_viridis_d(option = "plasma", direction = 1, begin = 1, end = 0.30) +
  theme_minimal() +
  labs(x = "Average Occasions for Binge Drinking (per month)", title = "History of Physical Abuse") +
  theme(
    axis.title.y = element_blank(),
    axis.text.y = element_text(color = "black", size = 9, family = "Avenir"),
    axis.title.x = element_text(color = "black", size = 15, family = "Avenir"),
...
pa2 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
...
ea1 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
  ...
  scale_color_viridis_d(option = "plasma", direction = 1, begin = 1, end = 0.30) +
  theme_minimal() +
  labs(x = "Average Occasions for Binge Drinking (per month)", title = "History of Emotional Abuse") +
  theme(
    axis.title.y = element_blank(),
    axis.text.y = element_text(color = "black", size = 9, family = "Avenir"),
    axis.title.x = element_text(color = "black", size = 15, family = "Avenir"),
...
ea2 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
...
sa11 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
  ...
  scale_color_viridis_d(option = "plasma", direction = 1, begin = 1, end = 0.30) +
  theme_minimal() +
  labs(x = "Average Occasions for Binge Drinking (per month)", title = "History of Sexual Abuse (Molestation)") +
  theme(
    axis.title.y = element_blank(),
    axis.text.y = element_text(color = "black", size = 9, family = "Avenir"),
    axis.title.x = element_text(color = "black", size = 15, family = "Avenir"),
...
sa12 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
...
sa21 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
  ...
  scale_color_viridis_d(option = "plasma", direction = 1, begin = 1, end = 0.30) +
  theme_minimal() +
  labs(x = "Average Occasions for Binge Drinking (per month)", title = "History of Sexual Abuse (Forced Sexual Touch to Abuser)") +
  theme(
    axis.title.y = element_blank(),
    axis.text.y = element_text(color = "black", size = 9, family = "Avenir"),
    axis.title.x = element_text(color = "black", size = 15, family = "Avenir"),
...
sa22 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
...
sa31 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
  ...
  scale_color_viridis_d(option = "plasma", direction = 1, begin = 1, end = 0.30) +
  theme_minimal() +
  labs(x = "Average Occasions for Binge Drinking (per month)", title = "History of Sexual Abuse (Rape)") +
  theme(
    axis.title.y = element_blank(),
    axis.text.y = element_text(color = "black", size = 9, family = "Avenir"),
    axis.title.x = element_text(color = "black", size = 15, family = "Avenir"),
...
sa32 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
...
n11 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
  ...
  scale_color_viridis_d(option = "plasma", direction = 1, begin = 1, end = 0.30) +
  theme_minimal() +
  labs(x = "Average Occasions for Binge Drinking (per month)", title = "History of Neglect (N1)") +
  theme(
    axis.title.y = element_blank(),
    axis.text.y = element_text(color = "black", size = 9, family = "Avenir"),
    axis.title.x = element_text(color = "black", size = 15, family = "Avenir"),
...
n12 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
...
n21 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
  ...
  scale_color_viridis_d(option = "plasma", direction = 1, begin = 1, end = 0.30) +
  theme_minimal() +
  labs(x = "Average Occasions for Binge Drinking (per month)", title = "History of Neglect (N2)") +
  theme(
    axis.title.y = element_blank(),
    axis.text.y = element_text(color = "black", size = 9, family = "Avenir"),
    axis.title.x = element_text(color = "black", size = 15, family = "Avenir"),
...
n22 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
...
subaddic1 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
            se = sd/sqrt(n)) |>
  filter(str_detect(Categories, "SubAddic") | Categories == "SubAddic") |>
  arrange(sum) |>
  ungroup() |>
  mutate(Categories = fct_reorder(Categories, mean)) |>
  mutate(sum = as.factor(sum)) |>
  ...
  scale_color_viridis_d(option = "plasma", direction = 1, begin = 1, end = 0.30) +
  theme_minimal() +
  labs(x = "Average Occasions for Binge Drinking (per month)", title = "History of Substance Addiction in HH") +
  theme(
    axis.title.y = element_blank(),
    axis.text.y = element_text(color = "black", size = 9, family = "Avenir"),
    axis.title.x = element_text(color = "black", size = 15, family = "Avenir"),
...
subaddic2 = left_join(bingedrinking4, bingedrinking3) |>
  group_by(Categories, sum) |>
  summarise(mean = mean(occasions),
            n = n(),
            sd = sd(occasions),
...
grid.arrange(subaddic1, subaddic2, nrow = 1)
...
aug_bingedrinking <- augment(bingeall4, newdata = grid3, se_fit = TRUE) |>
