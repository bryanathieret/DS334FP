...
log(\frac{1-p}{p}) = &\beta_1 (\text{MentalIllness}) + \beta_2 (\text{MentalIllness} \cdot \text{age}) + \beta_3 (\text{MentalIllness} \cdot \text{sex}) + \beta_4 (\text{MentalIllness} \cdot \text{age} \cdot \text{sex}) + \\
                  ...
                  &\beta_{21} (\text{PhysicalAbuse}) + \beta_{22} (\text{PhysicalAbuse} \cdot \text{age}) + \beta_{23} (\text{PhysicalAbuse} \cdot \text{sex}) + \beta_{24} (\text{PhysicalAbuse} \cdot \text{age} \cdot \text{sex}) + \\
                  &\beta_{25} (\text{EmotionalAbuse}) + \beta_{26} (\text{EmotionalAbuse} \cdot \text{age}) + \beta_{27} (\text{EmotionalAbuse} \cdot \text{sex}) + \beta_{28} (\text{EmotionalAbuse} \cdot \text{age} \cdot \text{sex}) + \\
                  &\beta_{29} (\text{SexualAbuse1}) + \beta_{30} (\text{SexualAbuse1} \cdot \text{age}) + \beta_{31} (\text{SexualAbuse1} \cdot \text{sex}) + \beta_{32} (\text{SexualAbuse1} \cdot \text{age} \cdot \text{sex}) + \\
                  &\beta_{33} (\text{SexualAbuse2}) + \beta_{34} (\text{SexualAbuse2} \cdot \text{age}) + \beta_{35} (\text{SexualAbuse2} \cdot \text{sex}) + \beta_{36} (\text{SexualAbuse2} \cdot \text{age} \cdot \text{sex}) + \\
                  &\beta_{37} (\text{SexualAbuse3}) + \beta_{38} (\text{SexualAbuse3} \cdot \text{age}) + \beta_{39} (\text{SexualAbuse3} \cdot \text{sex}) + \beta_{40} (\text{SexualAbuse3} \cdot \text{age} \cdot \text{sex}) + \\
                  &\beta_{41} (\text{Neglect1}) + \beta_{42} (\text{Neglect1} \cdot \text{age}) + \beta_{43} (\text{Neglect1} \cdot \text{sex}) + \beta_{44} (\text{Neglect1} \cdot \text{age} \cdot \text{sex}) + \\
                  &\beta_{45} (\text{Neglect2}) + \beta_{46} (\text{Neglect2} \cdot \text{age}) + \beta_{47} (\text{Neglect2} \cdot \text{sex}) + \beta_{48} (\text{Neglect2} \cdot \text{age} \cdot \text{sex}) + \\
                  &\beta_{49} (\text{SubstanceAddiction}) + \beta_{50} (\text{SubstanceAddiction} \cdot \text{age}) + \beta_{51} (\text{SubstanceAddiction} \cdot \text{sex}) + \beta_{52} (\text{SubstanceAddiction} \cdot \text{age} \cdot \text{sex}) \\
\end{split}
\end{equation*}
...
\beta_{13} (\text{SeparationDivorce}) + \beta_{14} (\text{SeparationDivorce} \cdot \text{age}) + \beta_{15} (\text{SeparationDivorce} \cdot \text{sex}) + \beta_{16} (\text{SeparationDivorce} \cdot \text{age} \cdot \text{sex}) + \\
\beta_{17} (\text{DomesticViolence}) + \beta_{18} (\text{DomesticViolence} \cdot \text{age}) + \beta_{19} (\text{DomesticViolence} \cdot \text{sex}) + \beta_{20} (\text{DomesticViolence} \cdot \text{age} \cdot \text{sex}) + \\
\beta_{21} (\text{PhysicalAbuse}) + \beta_{22} (\text{PhysicalAbuse} \cdot \text{age}) + \beta_{23} (\text{PhysicalAbuse} \cdot 
\text{sex}) + \beta_{24} (\text{PhysicalAbuse} \cdot \text{age} \cdot \text{sex}) + \\
\beta_{25} (\text{EmotionalAbuse}) + \beta_{26} (\text{EmotionalAbuse} \cdot \text{age}) + \beta_{27} (\text{EmotionalAbuse} \cdot \text{sex}) + \beta_{28} (\text{EmotionalAbuse} \cdot \text{age} \cdot \text{sex}) + \\
\beta_{29} (\text{SexualAbuse1}) + \beta_{30} (\text{SexualAbuse1} \cdot \text{age}) + \beta_{31} (\text{SexualAbuse1} \cdot \text{sex}) + \beta_{32} (\text{SexualAbuse1} \cdot \text{age} \cdot \text{sex}) + \\
\beta_{33} (\text{SexualAbuse2}) + \beta_{34} (\text{SexualAbuse2} \cdot \text{age}) + \beta_{35} (\text{SexualAbuse2} \cdot \text{sex}) + \beta_{36} (\text{SexualAbuse2} \cdot \text{age} \cdot \text{sex}) + \\
\beta_{37} (\text{SexualAbuse3}) + \beta_{38} (\text{SexualAbuse3} \cdot \text{age}) + \beta_{39} (\text{SexualAbuse3} \cdot \text{sex}) + \beta_{40} (\text{SexualAbuse3} \cdot \text{age} \cdot \text{sex}) + \\
